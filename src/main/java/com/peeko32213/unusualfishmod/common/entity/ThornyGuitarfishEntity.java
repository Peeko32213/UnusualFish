...
//REMOVE TILT FROM
public class ThornyGuitarfishEntity extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(ThornyGuitarfishEntity.class, EntityDataSerializers.BOOLEAN);
	protected int attackCooldown = 0;

	public ThornyGuitarfishEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public static boolean canSpawn(EntityType<ThornyGuitarfishEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
