...
//REMOVE TILT FROM
public class HatchetFishEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(HatchetFishEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public HatchetFishEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.HATCHET_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<HatchetFishEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
