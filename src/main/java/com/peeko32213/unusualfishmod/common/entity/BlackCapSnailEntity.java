...
public class BlackCapSnailEntity extends WaterAnimal implements Bucketable {
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BlackCapSnailEntity.class, EntityDataSerializers.BOOLEAN);


    public BlackCapSnailEntity(EntityType<? extends BlackCapSnailEntity> type, Level world) {
        super(type, world);
        this.moveControl = new BlackCapSnailEntity.MoveHelperController(this);
        this.maxUpStep = 1.0f;
    }
    ...
    public static boolean canSpawn(EntityType<BlackCapSnailEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
