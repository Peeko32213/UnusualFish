...
public class ZebraCornetfishEntity extends WaterAnimal {
    protected int attackCooldown = 0;

    public ZebraCornetfishEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 15.0D).add(Attributes.MOVEMENT_SPEED, 0.7F)
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, TropicalFish.class, true));
    ...
    public static boolean canSpawn(EntityType<ZebraCornetfishEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
