...
//REMOVE TILT FROM
public class YellowWhipGobyEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(AeroMonoEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public YellowWhipGobyEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.YELLOW_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<YellowWhipGobyEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
