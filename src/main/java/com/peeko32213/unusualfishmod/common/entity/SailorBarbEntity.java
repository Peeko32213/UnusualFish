...
//REMOVE TILT FROM
public class SailorBarbEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SailorBarbEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public SailorBarbEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.SAILOR_BARB_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<SailorBarbEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
