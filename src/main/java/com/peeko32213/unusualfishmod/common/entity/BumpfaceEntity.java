...
//REMOVE TILT FROM
public class BumpfaceEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BumpfaceEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public BumpfaceEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
