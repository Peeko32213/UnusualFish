...
//REMOVE TILT FROM
public class AeroMonoEntity extends SchoolingWaterAnimal implements Bucketable {
	...
	public AeroMonoEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
        return new ItemStack(ItemInit.AERO_MONO_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<AeroMonoEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
