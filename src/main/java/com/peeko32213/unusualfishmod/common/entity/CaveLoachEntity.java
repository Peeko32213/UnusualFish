...
//REMOVE TILT FROM
public class CaveLoachEntity extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(CaveLoachEntity.class, EntityDataSerializers.BOOLEAN);

	public CaveLoachEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.BLIND_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<CaveLoachEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
