...
//REMOVE TILT FROM
public class BarkAngelfishEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BarkAngelfishEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public BarkAngelfishEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.BARK_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<BarkAngelfishEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
