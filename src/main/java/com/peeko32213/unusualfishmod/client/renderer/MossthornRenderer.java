...
public class MossthornRenderer extends MobRenderer<MossthornEntity, MossthornModel<MossthornEntity>> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entities/mossthorn.png");
	...
	@Override
	public ResourceLocation getTextureLocation(MossthornEntity entity) {
		return TEXTURE;
	}

	//this code right here is what you insert when you want to give side flop to your fish \/
	protected void setupRotations(MossthornEntity p_116226_, PoseStack p_116227_, float p_116228_, float p_116229_, float p_116230_) {
