...
public class LobedSkipperEntity extends PathfinderMob implements Bucketable {
    ...
    public class SkipperPanicGoal extends PanicGoal {
        ...
        public SkipperPanicGoal(double speedIn) {
            super(LobedSkipperEntity.this, speedIn);
        }
...
//Rabbit Time is Over : (
    ...
    public static boolean canSpawn(EntityType<LobedSkipperEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
