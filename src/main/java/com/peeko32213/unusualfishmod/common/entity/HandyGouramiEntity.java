...
public class HandyGouramiEntity extends WaterAnimal implements Bucketable {
	...
	public HandyGouramiEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
