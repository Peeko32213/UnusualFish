...
//REMOVE TILT FROM
public class MossthornEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(MossthornEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public MossthornEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
