...
public class SquoddleEntity extends WaterAnimal implements Bucketable{
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SquoddleEntity.class, EntityDataSerializers.BOOLEAN);
	protected int attackCooldown = 0;


	public SquoddleEntity(EntityType<? extends SquoddleEntity> type, Level world) {
		super(type, world);
		this.moveControl = new SquoddleEntity.MoveHelperController(this);
		this.maxUpStep = 1.5f;
	}
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.SQUODDLE_BUCKET.get());
	}
	...
	public static boolean canSpawn(EntityType<SquoddleEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
