...
//REMOVE TILT FROM
public class MudPigEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(MudPigEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public MudPigEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
