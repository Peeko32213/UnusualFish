...
public class GnasherRenderer extends MobRenderer<GnasherEntity, GnasherModel<GnasherEntity>> {
	...
	@Override
	public ResourceLocation getTextureLocation(GnasherEntity entity) {
		return TEXTURE;
	}

	//this code right here is what you insert when you want to give side flop to your fish \/
	protected void setupRotations(GnasherEntity p_116226_, PoseStack p_116227_, float p_116228_, float p_116229_, float p_116230_) {
	...
	protected float getFlipDegrees(GnasherEntity fish) {
		return 0.0F;
	}
