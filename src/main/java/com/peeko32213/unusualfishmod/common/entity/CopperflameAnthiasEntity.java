...
//REMOVE TILT FROM
public class CopperflameAnthiasEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(CopperflameAnthiasEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public CopperflameAnthiasEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.COPPERFLAME_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<CopperflameAnthiasEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
