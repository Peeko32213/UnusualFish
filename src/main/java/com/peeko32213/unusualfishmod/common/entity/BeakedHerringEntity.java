...
//REMOVE TILT FROM
public class BeakedHerringEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BeakedHerringEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public BeakedHerringEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.BEAKED_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<BeakedHerringEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
