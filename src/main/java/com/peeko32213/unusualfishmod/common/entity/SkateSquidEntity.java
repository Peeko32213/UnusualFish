...
public class SkateSquidEntity extends WaterAnimal {
	public float squidRotation;

	public SkateSquidEntity(EntityType<? extends SkateSquidEntity> entityType, Level level) {
	...
	static class MoveHelperController extends MoveControl {
		private final SkateSquidEntity fish;

		MoveHelperController(SkateSquidEntity fish) {
			super(fish);
			this.fish = fish;
		}
	...
	public static boolean canSpawn(EntityType<SkateSquidEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
