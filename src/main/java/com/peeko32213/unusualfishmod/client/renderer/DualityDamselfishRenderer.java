...
public class DualityDamselfishRenderer extends MobRenderer<DualityDamselfishEntity, DualityDamselfishModel<DualityDamselfishEntity>> {
	...
	@Override
	public ResourceLocation getTextureLocation(DualityDamselfishEntity entity) {
		return TEXTURE;
	}

	//this code right here is what you insert when you want to give side flop to your fish \/
	protected void setupRotations(DualityDamselfishEntity p_116226_, PoseStack p_116227_, float p_116228_, float p_116229_, float p_116230_) {
