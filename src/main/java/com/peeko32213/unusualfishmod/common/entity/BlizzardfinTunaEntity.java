...
public class BlizzardfinTunaEntity extends WaterAnimal {

	public BlizzardfinTunaEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public static boolean canSpawn(EntityType<BlizzardfinTunaEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
