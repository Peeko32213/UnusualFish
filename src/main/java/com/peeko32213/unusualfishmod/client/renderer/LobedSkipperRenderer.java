...
import com.peeko32213.unusualfishmod.client.renderer.model.LobedSkipperModel;
...
public class LobedSkipperRenderer extends MobRenderer<LobedSkipperEntity, LobedSkipperModel<LobedSkipperEntity>> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entities/lobedskipper.png");
