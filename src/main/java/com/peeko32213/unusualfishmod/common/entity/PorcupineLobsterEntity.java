...
public class PorcupineLobsterEntity extends WaterAnimal implements Bucketable {
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(PorcupineLobsterEntity.class, EntityDataSerializers.BOOLEAN);
    protected int attackCooldown = 0;

    public PorcupineLobsterEntity(EntityType<? extends PorcupineLobsterEntity> type, Level world) {
        super(type, world);
        this.moveControl = new PorcupineLobsterEntity.MoveHelperController(this);
        this.maxUpStep = 1.5f;
    }
    ...
    public static boolean canSpawn(EntityType<PorcupineLobsterEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
