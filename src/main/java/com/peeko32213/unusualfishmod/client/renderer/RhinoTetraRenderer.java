...
public class RhinoTetraRenderer extends MobRenderer<RhinoTetraEntity, RhinoTetraModel<RhinoTetraEntity>> {
	...
	@Override
	public ResourceLocation getTextureLocation(RhinoTetraEntity entity) {
		return TEXTURE;
	}

	//this code right here is what you insert when you want to give side flop to your fish \/
	protected void setupRotations(RhinoTetraEntity p_116226_, PoseStack p_116227_, float p_116228_, float p_116229_, float p_116230_) {
