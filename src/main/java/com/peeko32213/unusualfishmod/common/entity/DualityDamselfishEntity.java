...
//REMOVE TILT FROM
public class DualityDamselfishEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(DualityDamselfishEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public DualityDamselfishEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.DUALITY_DAMSELFISH_BUCKET.get());
	}


	public static boolean canSpawn(EntityType<DualityDamselfishEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
