...
public class EntityInit {
	...
	public static final RegistryObject<EntityType<DualityDamselfishEntity>> DUALITY_DAMSELFISH = ENTITIES
			.register("duality_damselfish",
					() -> EntityType.Builder.of(DualityDamselfishEntity::new, MobCategory.WATER_CREATURE)
							.sized(0.5f, 0.5f)
	...
	public static final RegistryObject<EntityType<SailorBarbEntity>> SAILOR_BARB = ENTITIES.register("sailor_barb",
			() -> EntityType.Builder.of(SailorBarbEntity::new, MobCategory.WATER_AMBIENT).sized(0.9f, 0.9f)
	...
	public static final RegistryObject<EntityType<TripleTwirlPlecoEntity>> TRIPLE_TWIRL_PLECO = ENTITIES
			.register("triple_twirl_pleco",
					() -> EntityType.Builder.of(TripleTwirlPlecoEntity::new, MobCategory.WATER_AMBIENT)
							.sized(0.9f, 0.9f)
	...
	public static final RegistryObject<EntityType<ClownthornSharkEntity>> CLOWNTHORN_SHARK = ENTITIES
			.register("clownthorn_shark",
					() -> EntityType.Builder.of(ClownthornSharkEntity::new, MobCategory.WATER_CREATURE)
							.sized(0.6f, 0.6f)
	...
	public static final RegistryObject<EntityType<RedGiantSeaStarEntity>> REDGIANT_SEASTAR = ENTITIES
			.register("redgiant_seastar",
					() -> EntityType.Builder.of(RedGiantSeaStarEntity::new, MobCategory.WATER_CREATURE)
							.sized(2.0f, 0.5f)
	...
	public static final RegistryObject<EntityType<BumpfaceEntity>> BUMPFACE = ENTITIES.register("bumpface",
			() -> EntityType.Builder.of(BumpfaceEntity::new, MobCategory.WATER_CREATURE).sized(0.3f, 0.3f)
