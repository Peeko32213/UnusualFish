...
import com.peeko32213.unusualfishmod.common.entity.DemonHerringEntity;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import net.minecraft.client.renderer.entity.MobRenderer;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.util.Mth;

public class DemonHerringRenderer extends MobRenderer<DemonHerringEntity, DemonHerringModel<DemonHerringEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(DemonHerringEntity entity) {
        return TEXTURE;
    }

    //this code right here is what you insert when you want to give side flop to your fish \/
    protected void setupRotations(DemonHerringEntity p_116226_, PoseStack p_116227_, float p_116228_, float p_116229_, float p_116230_) {
