...
public class RipperEntity extends SchoolingWaterAnimal implements Bucketable {
	...
	public RipperEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
