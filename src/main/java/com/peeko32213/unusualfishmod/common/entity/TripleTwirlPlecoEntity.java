...
//REMOVE TILT FROM
public class TripleTwirlPlecoEntity extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(TripleTwirlPlecoEntity.class, EntityDataSerializers.BOOLEAN);

	public TripleTwirlPlecoEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
