...
//REMOVE TILT FROM
public class SpindlefishEntity extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SpindlefishEntity.class, EntityDataSerializers.BOOLEAN);
	protected int attackCooldown = 0;

	public SpindlefishEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
