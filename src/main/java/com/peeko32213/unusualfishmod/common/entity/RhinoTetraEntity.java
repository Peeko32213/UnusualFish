...
//REMOVE TILT FROM
public class RhinoTetraEntity extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(RhinoTetraEntity.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public RhinoTetraEntity(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(ItemInit.RHINO_TETRA_BUCKET.get());
	}

	public static boolean canSpawn(EntityType<RhinoTetraEntity> entity, LevelAccessor levelAccess, MobSpawnType spawnType, BlockPos pos, Random random ) {
